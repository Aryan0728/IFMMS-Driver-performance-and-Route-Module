...
<head>
    ...
    <script src="{{ asset('js/progress-bars.js') }}"></script>
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-collapse d-flex justify-content-between align-items-center" 
                       ...
                       role="button" 
                       aria-expanded="{{ request()->routeIs('route-management.*') || request()->routeIs('route-assignments.*') || request()->routeIs('driver-performance.*') ? 'true' : 'false' }}" 
                    ...
                    <div class="collapse {{ request()->routeIs('route-management.*') || request()->routeIs('route-assignments.*') || request()->routeIs('driver-performance.*') ? 'show' : '' }}" id="routeManagementMenu">
                        <ul class="nav flex-column collapse-menu">
                            <!-- Route Management -->
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('route-management.index') ? 'active' : '' }}" 
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('route-management.create') ? 'active' : '' }}" 
                                   href="{{ route('route-management.create') }}">
                                    <i class="fas fa-plus-circle"></i>
                                    Create Route
                                </a>
                            </li>
                            ...
                            <!-- Driver Performance -->
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('driver-performance.dashboard') ? 'active' : '' }}"
                                   href="{{ route('driver-performance.dashboard') }}">
                                    <i class="fas fa-tachometer-alt"></i>
                                    Driver Performance
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('driver-performance.rankings') ? 'active' : '' }}"
                                   href="{{ route('driver-performance.rankings') }}">
                ...
                @if(auth()->user()->role === 'Driver')
                <!-- Driver Routes & Assignments -->
                <li class="nav-item">
                    <a class="nav-link nav-link-collapse d-flex justify-content-between align-items-center" 
                       data-bs-toggle="collapse" 
                       href="#driverRoutesMenu" 
                       role="button" 
                       aria-expanded="{{ request()->routeIs('driver.routes.*') || request()->routeIs('driver.assignments.*') ? 'true' : 'false' }}" 
                       aria-controls="driverRoutesMenu">
                        <span>
                            <i class="fas fa-route"></i>
                            My Routes & Schedule
                        </span>
                    ...
                    <div class="collapse {{ request()->routeIs('driver.routes.*') || request()->routeIs('driver.assignments.*') ? 'show' : '' }}" id="driverRoutesMenu">
                        <ul class="nav flex-column collapse-menu">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('driver.assignments.today') ? 'active' : '' }}" 
                                   href="{{ route('driver.assignments.today') }}">
                                    <i class="fas fa-calendar-day"></i>
                                    Today's Routes
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('driver.assignments.index') ? 'active' : '' }}" 
                                   href="{{ route('driver.assignments.index') }}">
                                    <i class="fas fa-calendar-alt"></i>
                                    My Schedule
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('driver.assignments.history') ? 'active' : '' }}" 
                                   href="{{ route('driver.assignments.history') }}">
                                    <i class="fas fa-history"></i>
                                    Route History
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('driver.performance.index') ? 'active' : '' }}" 
                                   href="{{ route('driver.performance.index') }}">
                                    <i class="fas fa-tachometer-alt"></i>
                                    My Performance
                                </a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-collapse d-flex justify-content-between align-items-center" 
                       ...
                       href="#driverMenu" 
                       role="button" 
                       aria-expanded="{{ request()->routeIs('driver.incidents.*') ? 'true' : 'false' }}" 
                    ...
                    <div class="collapse {{ request()->routeIs('driver.incidents.*') ? 'show' : '' }}" id="driverMenu">
                        <ul class="nav flex-column collapse-menu">
                            <li class="nav-item">
