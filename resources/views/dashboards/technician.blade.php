...
<div class="page-header">
    ...
    <div class="row">
        ...
        <div class="col-xl-8">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="card-title">Route & Performance Management</h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <a href="{{ route('route-management.index') }}" class="card text-decoration-none h-100">
                                <div class="card-body text-center">
                                    <i class="fas fa-route fa-3x text-primary mb-3"></i>
                                    <h6 class="card-title">Route Management</h6>
                                    <p class="card-text small text-muted">Manage and optimize delivery routes</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="{{ route('driver-performance.dashboard') }}" class="card text-decoration-none h-100">
                                <div class="card-body text-center">
                                    <i class="fas fa-tachometer-alt fa-3x text-success mb-3"></i>
                                    <h6 class="card-title">Driver Performance</h6>
                                    <p class="card-text small text-muted">Monitor driver efficiency and metrics</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="{{ route('route-assignments.index') }}" class="card text-decoration-none h-100">
                                <div class="card-body text-center">
                                    <i class="fas fa-user-check fa-3x text-info mb-3"></i>
                                    <h6 class="card-title">Route Assignments</h6>
                                    <p class="card-text small text-muted">Assign routes to drivers</p>
                                </div>
                            </a>
                        </div>
                    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('route-management.index') }}" class="btn btn-outline-primary">
                            <i class="fas fa-route me-2"></i>Route Management
                        </a>
                        <a href="{{ route('driver-performance.dashboard') }}" class="btn btn-outline-success">
                            <i class="fas fa-tachometer-alt me-2"></i>Driver Performance
                        </a>
                        <a href="{{ route('driver-performance.rankings') }}" class="btn btn-outline-warning">
                            <i class="fas fa-trophy me-2"></i>Driver Rankings
                        </a>
                    </div>
                </div>
            </div>
