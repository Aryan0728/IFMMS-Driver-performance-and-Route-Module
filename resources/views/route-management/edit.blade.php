...
<input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" required value="{{ old('name', $route->route_name) }}" placeholder="e.g., Downtown Delivery Route">
@error('name')
...
<input type="datetime-local" class="form-control @error('start_time') is-invalid @enderror" id="start_time" name="start_time" required value="{{ old('start_time', $route->start_time ? $route->start_time->format('Y-m-d\TH:i') : '') }}">
@error('start_time')
<div class="invalid-feedback">{{ $message }}</div>
@enderror
</div>
...
<input type="datetime-local" class="form-control @error('estimated_end_time') is-invalid @enderror" id="estimated_end_time" name="estimated_end_time" required value="{{ old('estimated_end_time', $route->estimated_end_time ? $route->estimated_end_time->format('Y-m-d\TH:i') : '') }}">
...
<textarea class="form-control @error('optimized_waypoints') is-invalid @enderror" id="waypoints" name="optimized_waypoints" rows="6" required readonly placeholder='Waypoints will appear here as JSON'>{{ old('optimized_waypoints', $route->optimized_waypoints ?? '') }}</textarea>
