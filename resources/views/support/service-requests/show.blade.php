...
<div class="container-fluid py-4">
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <!-- Actions -->
            @if(auth()->user()->role === 'Admin' || auth()->user()->role === 'Technician' || auth()->id() === $serviceRequest->requester_id)
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white">
                    ...
                    <form action="{{ route('support.service-requests.update', $serviceRequest) }}" method="POST" class="mb-3">
                        ...
                        <div class="mb-2">
                            ...
                            <select name="status" class="form-select form-select-sm">
                                <option value="open" {{ $serviceRequest->status == 'open' ? 'selected' : '' }}>Open</option>
                    ...
                    <form action="{{ route('support.service-requests.priority', $serviceRequest) }}" method="POST" class="mb-3">
                        ...
                        <div class="mb-2">
                            ...
                            <select name="priority" class="form-select form-select-sm">
                                ...
                                <option value="critical" {{ $serviceRequest->priority == 'critical' ? 'selected' : '' }}>Critical</option>
                            </select>
                        </div>
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <div class="timeline-simple">
                        ...
                        @if($serviceRequest->response_time)
                        <div class="timeline-item">
                            <div class="timeline-marker bg-info"></div>
                            <div class="timeline-content">
                                <strong>First Response</strong>
                                <small class="d-block text-muted">{{ $serviceRequest->response_time->format('M d, Y h:i A') }}</small>
                            </div>
                        </div>
                        @endif
